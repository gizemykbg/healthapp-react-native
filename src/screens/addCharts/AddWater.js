            ...
            <ScrollView style={styles.main} showsVerticalScrollIndicator={false}>
                {
                    destination ?
                        <ChartDestinationButton
                            ...
                            buttonTitle="İçeceğiniz Su Miktarını Belirlemek için Tıklayınız"
                            placeholder="Örnek: 9 Bardak"
                            destination={destination}
                            onPressDestination={() => alert('ok')}
                        ...
                        <>
                            <View style={styles.destinationView}>
                                <Text style={styles.destinationFinishText} numberOfLines={2} ellipsizeMode="tail">Hedefine Kalan Tüketim : 2 Bardak</Text>
                                <Text style={styles.destinationText} numberOfLines={1} ellipsizeMode="tail">Hedefin : 9 Bardak</Text>
                            </View>
                            ...
                            <View style={{ marginTop: 10, zIndex: 1 }}>
                                <Text style={[styles.exerciseTracking, { fontSize: 16, fontWeight: "500" }]}>Su Tüketim Takibi</Text>
                                <Text style={[styles.exerciseTracking, { fontSize: 15, fontWeight: "400" }]}>Aşağıdan tükettiğiniz su miktarını ölçüsü bardak olacak şekilde seçiniz.</Text>
                                <View style={{ zIndex: 1, }}>
                                    {/* dropdown A */}
                                    <DropDownPicker
                                      //zIndex={zIndex.dropdownA}
                                        ...
                                        style={{ backgroundColor: colors.lightBlue, borderWidth: 1, borderRadius: 15, borderColor: colors.white }}
                                        itemStyle={{
                                        ...
                                        activeLabelStyle={{ color: colors.orange, fontWeight: "600", fontSize: 17 }}
                                        dropDownStyle={{ backgroundColor: colors.lightBlue, borderWidth: 1, borderColor: colors.white, borderRadius: 15 }}
                                    />
                                </View>

                                <Button
                                    title="Kaydet"
                                    style={{ paddingVertical: 10, marginHorizontal: 80, backgroundColor:colors.pink }}
