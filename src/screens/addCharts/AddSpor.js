...
const values = [{y: 50}, {y: 45}, {y: 45}, {y: 0}, {y: 0}, {y: 0}, {y: 0}];
          ...
          <>
            ...
            <View style={{marginTop: 10, zIndex: 1}}>
              ...
              <Text
                ...
                Aşağıdan bir aktivite ve aktivetin süresini seçiniz.
              </Text>
              <View style={{zIndex: 1}}>
                {/* dropdown A */}
                <DropDownPicker
