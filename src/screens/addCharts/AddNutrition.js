...
/* const getData = async () => {
    ...
    const breakfastRemoveRow = (index) => {
        const filteredItems = breakfast.filter(filteredItem => index !== filteredItem)
    ...
    const breakfastButton = () => {
        ...
        breakfast.map((val, index) => {
            newbreakfast.push({ foodName: val.value1, foodQuantity: val.value2, id: val.index })
        }
        )
    ...
    const lunchButton = () => {
        let newlunch = [];
        lunch.map((val, index) => {
            newlunch.push({ foodName: val.value1, foodQuantity: val.value2, id: val.index })
        }
        )
        //console.log(breakfast)
    ...
    const snackButton = () => {
        let newsnack = [];
        snack.map((val, index) => {
            newsnack.push({ foodName: val.value1, foodQuantity: val.value2, id: val.index })
        }
        )
        //console.log(breakfast)
    ...
    const dinnerButton = () => {
        ...
        dinner.map((val, index) => {
            newdinner.push({ foodName: val.value1, foodQuantity: val.value2, id: val.index })
        }
        )
        //console.log(breakfast)
    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView style={styles.main} showsVerticalScrollIndicator={false}>
                <Text style={{ color: colors.blue, fontWeight: "500", fontSize: 18, textAlign: 'center', paddingBottom: 10 }}>Örnek Öğün Listesi</Text>
                <View style={{ flexWrap: "wrap", flexDirection: 'row', justifyContent: 'space-between', height: 180, padding: 10, marginBottom: 10, borderColor: colors.blue, borderWidth: 2, borderRadius: 8 }}>
                    <View style={{ paddingHorizontal: 3, paddingBottom: 5 }}>
                        <Text style={{ color: colors.pink, fontWeight: "600", fontSize: 16 }}>-Kahvaltı-</Text>
                        <Text style={{ color: colors.dark, fontWeight: "400", fontSize: 14 }}>1 yumurta</Text>
                        <Text style={{ color: colors.dark, fontWeight: "400", fontSize: 14 }}>1 dilim kepekli ekmek</Text>
                        <Text style={{ color: colors.dark, fontWeight: "400", fontSize: 14 }}>1 çay bardağı çay</Text>
                    </View>
                    <View style={{ paddingHorizontal: 3, paddingBottom: 5 }}>
                        <Text style={{ color: colors.pink, fontWeight: "600", fontSize: 16 }}>-Öğle Yemeği-</Text>
                        <Text style={{ color: colors.dark, fontWeight: "400", fontSize: 14 }}>1 kase mercimek çorbası</Text>
                        <Text style={{ color: colors.dark, fontWeight: "400", fontSize: 14 }}>1 dilim kepekli ekmek</Text>
                        <Text style={{ color: colors.dark, fontWeight: "400", fontSize: 14 }}>1 kase salata</Text>
                    </View>
                    <View style={{ paddingHorizontal: 3, paddingBottom: 5 }}>
                        <Text style={{ color: colors.pink, fontWeight: "600", fontSize: 15 }}>-Ara Öğün-</Text>
                        <Text style={{ color: colors.dark, fontWeight: "400", fontSize: 14 }}>1 avuç kuru kayısı</Text>
                        <Text style={{ color: colors.dark, fontWeight: "400", fontSize: 14 }}>1 fincan türk kahvesi</Text>
                    </View>
                    <View style={{ paddingHorizontal: 3, paddingBottom: 5 }}>
                        <Text style={{ color: colors.pink, fontWeight: "600", fontSize: 16 }}>-Akşam Yemeği-</Text>
                        <Text style={{ color: colors.dark, fontWeight: "400", fontSize: 14 }}>3 yemek kaşığı pilav</Text>
                        <Text style={{ color: colors.dark, fontWeight: "400", fontSize: 14 }}>300 gram tavuk pirzola</Text>
                        <Text style={{ color: colors.dark, fontWeight: "400", fontSize: 14 }}>1 bardak ayran</Text>
                    </View>
                </View>


                <Text style={{ fontWeight: "400", fontSize: 17, textAlign: 'auto', paddingBottom: 30, color: colors.dark }}>Beslenme düzeni oluşturabilmek için öğünlerini aşağıdaki alana yazınız.</Text>
                ...
                {
                    showFood &&
                    <View style={{ backgroundColor: colors.lightBlue, borderRadius: 8, padding: 10 }}>
                        <View style={{ marginBottom: 20 }}>
                            <Text style={{ textAlign: 'center', fontWeight: "500", fontSize: 18, color: colors.dark }}>Sabah / Kahvaltı</Text>
                            {
                                Store.breakfast.map((item, index) => {
                                    return (
                                        <View key={index} style={{ flex: 1, flexDirection: 'row', borderBottomWidth: 2, padding: 5, borderBottomColor: colors.white }}>
                                            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'flex-start', borderRightWidth: 2, borderRightColor: colors.white }}>
                                                <Text style={{ fontWeight: "500", fontSize: 14, color: colors.dark }}>{item.foodName}</Text>
                                            </View>
                                            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'flex-start', paddingLeft: 5 }}>
                                                <Text style={{ fontWeight: "500", fontSize: 14, color: colors.dark }}>{item.foodQuantity}</Text>
                                            </View>
                        ...
                        <View style={{ marginBottom: 20 }}>
                            <Text style={{ textAlign: 'center', fontWeight: "500", fontSize: 18, color: colors.dark }}>Öğle</Text>
                            {
                        ...
                        <View style={{ marginBottom: 20 }}>
                            <Text style={{ textAlign: 'center', fontWeight: "500", fontSize: 18, color: colors.dark }}>Ara Öğün</Text>
                            {
                        ...
                        <View>
                            <Text style={{ textAlign: 'center', fontWeight: "500", fontSize: 18, color: colors.dark }}>Akşam</Text>
                            {
