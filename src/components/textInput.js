...
const TextInputAdd = ({ items, add, remove, onPress, onChangeText1, onChangeText2 }) => {
    return (
        <>
            {
                items.map((val, key) => {
                        ...
                        <View style={{}}>
                            <View style={styles.container} key={val.index}>
                                <View style={{ flex: 2.5, paddingRight: 10 }} >
                                    <Text style={{ fontWeight: "500", fontSize: 15, paddingBottom: 5 }}>Yemek Adı :</Text>
                                    <TextInput
                                ...
                                <View style={{ flex: 2, paddingHorizontal: 10 }}>
                                    <Text style={{ fontWeight: "500", fontSize: 15, paddingBottom: 5 }}>Yemek Miktarı</Text>
                                    <TextInput
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'center', marginTop: 15, marginBottom: 5 }} >
                ...
                <TouchableOpacity onPress={onPress} style={{ marginHorizontal: 10, paddingVertical: 10, paddingHorizontal: 15, backgroundColor: colors.orange, borderRadius: 20 }}>
                    <Text style={{ fontWeight: "500", fontSize: 15, color: colors.dark }}>Yemekleri Kaydet</Text>
                </TouchableOpacity>
            </View >
